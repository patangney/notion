...
export async function POST(request: NextRequest) {
  ...
  console.log("User document data:", userDoc.exists ? userDoc.data() : "Document does not exist");
  ...
  const roomsCollection = adminDb.collection(`users/${sessionClaims.email}/rooms`);
